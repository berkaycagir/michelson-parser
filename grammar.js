...
var grammar = {
    ...
    {"name": "parameter", "symbols": ["parameter$string$1", "__", "type", "_", {"literal":";"}]},
    ...
    {"name": "storage", "symbols": ["storage$string$1", "__", "type", "_", {"literal":";"}]},
    ...
    {"name": "code$ebnf$1$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "code$ebnf$1", "symbols": ["code$ebnf$1", "code$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "code", "symbols": ["code$string$1", "_", {"literal":"{"}, "_", "code$ebnf$1", {"literal":"}"}, "_", {"literal":";"}]},
    ...
    {"name": "type$ebnf$2", "symbols": [{"literal":")"}], "postprocess": id},
    {"name": "type$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "type", "symbols": ["type$ebnf$1", "_", "type$string$22", "__", "type", "__", "type", "_", "type$ebnf$2"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$22", "_", {"literal":"{"}, "_", "instruction", "_", {"literal":";"}, "_", {"literal":"}"}]},
    {"name": "instruction$string$23", "symbols": [{"literal":"D"}, {"literal":"I"}, {"literal":"P"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instruction", "symbols": ["instruction$string$23", "__", "int", "__", {"literal":"{"}, "_", "instruction", "_", {"literal":";"}, "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$1$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction$ebnf$2$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$42", "_", {"literal":"{"}, "_", "instruction$ebnf$1", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$2", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$4$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$43", "_", {"literal":"{"}, "_", "instruction$ebnf$3", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$4", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$5$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction$ebnf$6$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$44", "_", {"literal":"{"}, "_", "instruction$ebnf$5", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$6", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$7$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$45", "_", {"literal":"{"}, "_", "instruction$ebnf$7", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$8", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$9$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    ...
    {"name": "instruction$ebnf$10$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$10", "symbols": ["instruction$ebnf$10", "instruction$ebnf$10$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction", "symbols": ["instruction$string$46", "_", {"literal":"{"}, "_", "instruction$ebnf$9", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$10", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$11$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$11", "symbols": ["instruction$ebnf$11", "instruction$ebnf$11$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction$ebnf$12", "symbols": []},
    {"name": "instruction$ebnf$12$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$12", "symbols": ["instruction$ebnf$12", "instruction$ebnf$12$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction", "symbols": ["instruction$string$47", "_", {"literal":"{"}, "_", "instruction$ebnf$11", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$12", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$14$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$14", "symbols": ["instruction$ebnf$14", "instruction$ebnf$14$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction", "symbols": ["instruction$string$48", "_", {"literal":"{"}, "_", "instruction$ebnf$13", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$14", "_", {"literal":"}"}]},
    ...
    {"name": "instruction$ebnf$15$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$15", "symbols": ["instruction$ebnf$15", "instruction$ebnf$15$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction$ebnf$16", "symbols": []},
    {"name": "instruction$ebnf$16$subexpression$1", "symbols": ["instruction", "_", {"literal":";"}, "_"]},
    {"name": "instruction$ebnf$16", "symbols": ["instruction$ebnf$16", "instruction$ebnf$16$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction", "symbols": ["instruction$string$49", "_", {"literal":"{"}, "_", "instruction$ebnf$15", "_", {"literal":"}"}, "_", {"literal":"{"}, "_", "instruction$ebnf$16", "_", {"literal":"}"}]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$53", "__", "instruction"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$58", "__", "type"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$65", "__", "instruction"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$78", "__", "int"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$80", "__", "pushh"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$82", "__", "type"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$83", "__", "type"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$103", "__", "type"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$105", "__", "int"]},
    ...
    {"name": "instruction", "symbols": ["instruction$string$107", "__", "int"]},
    ...
    {"name": "pushh", "symbols": ["pushh$string$1", "__", "dqstring"]},
    ...
    {"name": "pushh", "symbols": ["pushh$string$2", "__", "sqstring"]},
    {"name": "pushh$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "pushh$ebnf$1", "symbols": ["pushh$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "pushh", "symbols": ["type", "__", "pushh$ebnf$1"]}
]
  , ParserStart: "main"
}
