...
var grammar = {
    ...
    {"name": "parameter$ebnf$1$subexpression$1", "symbols": ["_", (lexer.has("annot") ? {type: "annot"} : annot)]},
    ...
    {"name": "parameter", "symbols": [(lexer.has("parameter") ? {type: "parameter"} : parameter), "parameter$ebnf$1", "_", "type", "_", "semicolons"], "postprocess": singleArgKeywordToJson},
    {"name": "storage$ebnf$1", "symbols": []},
    {"name": "storage$ebnf$1$subexpression$1", "symbols": ["_", (lexer.has("annot") ? {type: "annot"} : annot)]},
    ...
    {"name": "storage", "symbols": [(lexer.has("storage") ? {type: "storage"} : storage), "storage$ebnf$1", "_", "type", "_", "semicolons"], "postprocess": singleArgKeywordToJson},
    ...
    {"name": "type", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("singleArgType") ? {type: "singleArgType"} : singleArgType), "_", "type$subexpression$1", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": singleArgKeywordWithParenToJson},
    ...
    {"name": "data", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("singleArgData") ? {type: "singleArgData"} : singleArgData), "_", "data$subexpression$1", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": singleArgKeywordWithParenToJson},
    ...
    {"name": "subInstruction$ebnf$1$subexpression$1$ebnf$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": id},
    {"name": "subInstruction$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subInstruction$ebnf$1$subexpression$1", "symbols": ["instruction", "subInstruction$ebnf$1$subexpression$1$ebnf$1", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"]},
    {"name": "subInstruction$ebnf$1", "symbols": ["subInstruction$ebnf$1$subexpression$1"]},
    {"name": "subInstruction$ebnf$1$subexpression$2$ebnf$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": id},
    {"name": "subInstruction$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subInstruction$ebnf$1$subexpression$2", "symbols": ["instruction", "subInstruction$ebnf$1$subexpression$2$ebnf$1", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"]},
    ...
    {"name": "subInstruction$ebnf$2$subexpression$1$ebnf$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": id},
    {"name": "subInstruction$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subInstruction$ebnf$2$subexpression$1", "symbols": ["instruction", "subInstruction$ebnf$2$subexpression$1$ebnf$1", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"]},
    {"name": "subInstruction$ebnf$2", "symbols": ["subInstruction$ebnf$2$subexpression$1"]},
    {"name": "subInstruction$ebnf$2$subexpression$2$ebnf$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": id},
    {"name": "subInstruction$ebnf$2$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subInstruction$ebnf$2$subexpression$2", "symbols": ["instruction", "subInstruction$ebnf$2$subexpression$2$ebnf$1", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"]},
    ...
    {"name": "instruction", "symbols": ["instructions", "instruction$ebnf$3", "_", "type"], "postprocess": singleArgKeywordToJson},
    ...
    {"name": "instruction", "symbols": ["instructions", "instruction$ebnf$4", "_", "data"], "postprocess": singleArgKeywordToJson},
    ...
    {"name": "instruction", "symbols": ["instructions", "instruction$ebnf$5", "_", "type", "_", "type", "_", "subInstruction"], "postprocess": tripleArgKeyWordToJson},
    ...
    {"name": "instruction", "symbols": ["instructions", "instruction$ebnf$7", "_", "type", "_", "type"], "postprocess": doubleArgKeywordToJson},
    ...
    {"name": "instruction", "symbols": [{"literal":"PUSH"}, "instruction$ebnf$8", "_", "type", "_", "data"], "postprocess": doubleArgKeywordToJson},
    {"name": "instruction", "symbols": [{"literal":"PUSH"}, "_", "type", "_", (lexer.has("lbrace") ? {type: "lbrace"} : lbrace), "_", (lexer.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": pushToJson},
    {"name": "instruction$subexpression$1", "symbols": [{"literal":"DIP"}]},
    {"name": "instruction$subexpression$1", "symbols": [{"literal":"DUP"}]},
    {"name": "instruction", "symbols": ["instruction$subexpression$1", "_", (lexer.has("number") ? {type: "number"} : number), "_", "subInstruction"], "postprocess": dipnToJson},
    {"name": "instruction$subexpression$2", "symbols": [{"literal":"DIG"}]},
    {"name": "instruction$subexpression$2", "symbols": [{"literal":"DUG"}]},
    {"name": "instruction", "symbols": ["instruction$subexpression$2", "_", (lexer.has("number") ? {type: "number"} : number)], "postprocess": dignToJson},
    ...
    {"name": "subData$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "subData$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "subData$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "subData$ebnf$2$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "_$subexpression$2", "symbols": ["_$subexpression$2$ebnf$1", (lexer.has("comment") ? {type: "comment"} : comment), (lexer.has("ws") ? {type: "ws"} : ws)]},
    {"name": "_", "symbols": ["_$subexpression$2", "_"], "postprocess": function(d) {return null;}},
    {"name": "__$subexpression$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)]},
    {"name": "__", "symbols": ["__$subexpression$1"]},
    {"name": "__$subexpression$2$ebnf$1", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": id},
    {"name": "__$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "__$subexpression$2", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws), (lexer.has("comment") ? {type: "comment"} : comment), "__$subexpression$2$ebnf$1"]},
